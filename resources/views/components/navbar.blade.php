        ...
        <div class="fixed top-10 w-full max-w-[1280px] px-16 z-20">
            <div class="flex items-center w-full max-w-[1280px] h-[100px] mx-auto rounded-full p-5 pl-9 justify-between bg-white shadow-[0px_23px_35px_0px_#0C0F2405]">
                ...
                <ul class="flex items-center gap-8">
                    <li>
                        <a href="#Products" class="font-semibold text-lg leading-[22.68px] text-patungan-grey">Layanan</a>
                    </li>
                    <div class="h-[18px] border-[1.5px] border-patungan-border"></div>
                    <li>
                        <a href="#How-It-Works" class="font-semibold text-lg leading-[22.68px] text-patungan-grey">Cara Pesan</a>
                    </li>
                    <div class="h-[18px] border-[1.5px] border-patungan-border"></div>
                    <li>
                    ...
                    <div class="h-[18px] border-[1.5px] border-patungan-border"></div>
                    <li>
                        <a href="#FAQ" class="font-semibold text-lg leading-[22.68px] text-patungan-grey">FAQ</a>
                    </li>
                </ul>
