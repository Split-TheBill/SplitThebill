        ...
        <div class="flex gap-9 mb-20">
                            ...
                            <div class="flex flex-col gap-6">
                                ...
                                <div class="message-card flex gap-4">
                                    ...
                                    <div class="flex flex-col flex-1 rounded-3xl rounded-tl-[4px] p-6 gap-6 bg-patungan-bg-grey">
                                        ...
                                        <span class="time font-bold leading-5 text-patungan-grey">{{$message->created_at->format('M d, Y H:s')}}</span>
                                    </div>
                                </div>
                                @endforeach
                            </div>
                        ...
                        <div class="flex flex-col rounded-[32px] p-8 gap-8 bg-white overflow-hidden">
                                ...
                                <div class="flex flex-col justify-between rounded-3xl border border-patungan-border p-6 gap-6">
                                    ...
                                    <div class="flex flex-col gap-4">
                                        ...
                                        <div class="flex items-center justify-between">
                                            ...
                                            <p class="font-bold text-xl leading-[25px]">{{$bookingDetails->product->created_at->format('M d, Y')}}</p>
                                        </div>
                                        <div class="flex items-center justify-between">
                            ...
                            <div id="Personal-Information" class="flex flex-col gap-5">
                                ...
                                <label class="flex flex-col gap-4">
                                    ...
                                    <div class="flex items-center rounded-3xl border border-patungan-border p-6 gap-4 bg-patungan-bg-grey focus-within:border-patungan-orange transition-all duration-300">
                                        ...
                                        <div class="flex h-6 border border-patungan-border"></div>
                                        <input type="tel" value="{{$bookingDetails->phone}}" readonly class="appearance-none outline-none bg-patungan-bg-grey w-full font-bold text-xl leading-[25px] placeholder:text-patungan-black">
                                    </div>
                                </label>
                                <label class="flex flex-col gap-4">
                            ...
                            <div id="Transfer-Informations" class="flex flex-col gap-5">
                                ...
                                <label class="flex flex-col gap-4">
                                    ...
                                    <div class="flex items-center rounded-3xl border border-patungan-border p-6 gap-4 bg-patungan-bg-grey focus-within:border-patungan-orange transition-all duration-300">
                                        ...
                                        <div class="flex h-6 border border-patungan-border"></div>
                                        <input type="text" value="{{$bookingDetails->customer_bank_name}}" readonly class="appearance-none outline-none bg-patungan-bg-grey w-full font-bold text-xl leading-[25px] placeholder:text-patungan-black" pattern="[0-9 ]*" title="Only numbers and spaces are allowed" placeholder="Nomor Rekening Kamu?">
                                    </div>
                                </label>
                                <label class="flex flex-col gap-4">
                                    ...
                                    <div class="flex items-center rounded-3xl border border-patungan-border p-6 gap-4 bg-patungan-bg-grey focus-within:border-patungan-orange transition-all duration-300">
                                        ...
                                        <div class="flex h-6 border border-patungan-border"></div>
                                        <input type="text" value="{{$bookingDetails->customer_bank_account}}" readonly class="appearance-none outline-none bg-patungan-bg-grey w-full font-bold text-xl leading-[25px] placeholder:text-patungan-black" pattern="[0-9 ]*" title="Only numbers and spaces are allowed" placeholder="Nomor Rekening Kamu?">
                                    </div>
                                </label>
                                <label class="flex flex-col gap-4">
                                    <p class="font-bold text-xl leading-[25px] text-patungan-grey">Bank Account Number</p>
                            ...
                            <div id="Payment-Proof" class="flex flex-col gap-4">
                                ...
                                <div class="relative flex items-center rounded-3xl border border-patungan-border p-6 gap-4 bg-patungan-bg-grey focus-within:border-patungan-orange transition-all duration-300">
                                    ...
                                    <div class="flex h-6 border border-patungan-border"></div>
                                    <p id="File-Name" class="w-full font-bold text-xl leading-[25px]"><img src="{{Storage::url($bookingDetails->proof)}}" class="w-full h-full object-contain" alt="logo"></p>
            ...
            <div id="Member-Status" class="flex flex-col w-full max-w-[446px] rounded-[32px] overflow-hidden">
                ...
                <div class="relative flex flex-col rounded-[32px] p-8 gap-6 bg-white">
                    ...
                    @endphp
                    <h2 class="font-bold text-xl leading-[25px]">Group Member {{$totalParticipants}}/{{$bookingDetails->product->capacity}}</h2>
                    <hr class="border-patungan-border">
                    <div class="flex flex-col gap-6">
                        ...
                        <div class="flex items-center gap-4">
                            ...
                            <div class="flex flex-col gap-[6px]">
                                ...
                                <p class="font-semibold text-lg leading-[22px] text-patungan-grey">Joined {{$participant->created_at->format('M d, Y    ')}}</p>
                            </div>
                        </div>
                        @endforeach
